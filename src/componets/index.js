...
import teeth from ''
import surgery from '../componets/icons/oral.png'
import pain from '../componets/icons/headache.png'
import dirl from '../componets/icons/drill.png'
import dentl from '../componets/images 2/dental cinik.jpeg'
      ...
      <section className='relative 2xl:px-64 py-32 sm:px-8 lg:px-16 xl:px-40 px-4' >
        ...
        <div className='mt-24 flex flex-col md:flex-row'>
          <div className='bg-white shadow-lg text-center items-center rounded-xl p-8 mx-4 my-2'>
            ...
            <button className='p-2 border-2 border-blue-500 rounded-lg font-semibold'>Read More</button>
          </div>
      ...
      <section className='relative 2xl:px-64 md:py-32 py-10 sm:py-10 sm:px-8 lg:px-16 xl:px-40 px-4 bg-slate-50'>
        <div className='flex flex-col md:flex-row'>
          <div className='w-full lg:w-1/2 lg:px-8 '>
            ...
            <h2 className='text-3xl font-extrabold pt-3'>Why choose the AIIMS Center ?</h2>
      ...
      <footer className='relative bg-gray-900 2xl:px-64 md:py-32 py-10 sm:py-10 sm:px-8 lg:px-16 xl:px-40 px-4 '>
        <div className='flex md:flex-row flex-col  '>
          ...
          <div className='text-white w-full lg:w-1/6 lg:mt-0 lg:mx-4 lg:pr-8 mt-8'>
            ...
            <p className='pt-2'>Oral Surgery</p>
          ...
          <div className='w-full lg:w-2/6 mt-8 lg:mt-0 lg:mx-4 lg:pr-8'>
            ...
            <ul className='text-white pt-4'>
              <li className='flex flex-row items-center'>
                <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                  <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
                </svg></span>
                <span className='ml-2'>1983 Kerry Way, Whittier, CA, USA</span>
              </li>
              <li className='flex flex-row items-center pt-2'>
                <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
                  <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z" />
                </svg></span>
                <span className='ml-2'>+1 562-789-1935</span>
              </li>
              <li className='flex flex-row items-center pt-2'>
                <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-clock-fill" viewBox="0 0 16 16">
          ...
          <div className='text-white  w-full lg:w-1/6 lg:mt-0 mt-8 lg:mx-4'>
            ...
            <ul className='flex text-white mt-3'>
              ...
              <li className='ml-5'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z" />
              </svg></li>
              <li className='ml-5'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
              ...
              <li className='ml-5'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-youtube " viewBox="0 0 16 16">
